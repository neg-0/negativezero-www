    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      <section className="py-24 px-4 bg-white/[0.01]">
        <div className="container mx-auto max-w-5xl text-center mb-16">
          ...
          <p className="text-slate-300">Enterprise SaaS management is too expensive. Spreadsheets are too slow. Shadow IT Detective is just right.</p>
        </div>
        ...
        <div className="container mx-auto max-w-5xl grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="p-8 border border-white/20 bg-black/40 hover:border-cyan-400/30 transition-all group hover:-translate-y-1">
