    ...
    <div className="min-h-screen bg-[#0d1117] text-slate-200 font-sans selection:bg-emerald-500/30">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 border border-white/20 bg-black/20 rounded-xl">
              <h3 className="text-slate-300 font-bold mb-4 uppercase text-sm tracking-widest">Full PMS</h3>
            ...
            <div className="p-8 border border-white/20 bg-black/20 rounded-xl">
              <h3 className="text-slate-300 font-bold mb-4 uppercase text-sm tracking-widest">Manual / Zapier</h3>
      ...
      <section className="py-24 px-4 bg-white/[0.01]">
        <div className="container mx-auto max-w-5xl text-center mb-16">
          ...
          <p className="text-slate-300 italic">Built for DIY Landlords with 5-50 units.</p>
        </div>
        ...
        <div className="container mx-auto max-w-5xl grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="p-8 border border-white/20 bg-black/40 hover:border-emerald-400/30 transition-all group hover:-translate-y-1">
